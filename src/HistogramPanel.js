...
export class HistogramPanel extends Component {
  ...
  componentDidUpdate() {
    ...
    if (this.props.currentActiveDataVizPanel === "HistogramPanel" && !this.props.setPanelFromNotebook) {
    ...
    }else if((this.props.currentActiveDataVizPanel === "HistogramPanel" && this.props.setPanelFromNotebook)) {
