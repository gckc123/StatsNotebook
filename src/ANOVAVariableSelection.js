...
export class ANOVAVariableSelection extends Component {
    ...
    render () {
        ...
        return (
            <div className="analysis-pane">
                <div className="ANOVA-Variable-Selection-Box">
                    <div> Variables</div>
                    <div></div>
                    <div>Outcome
                    </div>

                    <div className="ANOVA-Available-Variable-List-Container" 
                    ...
                    <div></div>
                    <div>Factors/ Covariates 
                        <StyledTooltip title="Numeric variables will be treated as covariates and cateogrical variables will be treated as factors.">
