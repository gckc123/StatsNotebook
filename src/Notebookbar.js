    ...
    render() {
        return (
            <div className="notebook-bar">
                <StyledButton disableRipple onClick={() => this.props.runScriptCallback(true)}> 
                ...
                <StyledButton disableRipple onClick={() => this.props.mergeBlkCallback()}>
                    <FontAwesomeIcon icon={faObjectUngroup}/><div className="ml-1">Merge</div>
                </StyledButton>
