...
export class MatchingVariableSelection extends Component {
    ...
    render () {
        return (
            <div className="analysis-pane">
                <div className="Matching-Variable-Selection-Box">
                    <div> Variables
                    ...
                    <div></div>
                    <div>Outcome</div>
                    <div className="Matching-Available-Variable-List-Container" 
